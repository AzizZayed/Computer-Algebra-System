...
BracketFunction::BracketFunction(const ExpressionProperties& properties, Expression* argument, const char* openBracket, const char* closeBracket)
...
bool BracketFunction::equals(Expression* other)
{
    ...
    return argument->equals(otherBracketFunction->argument)
        && strcmp(openBracket, otherBracketFunction->openBracket) == 0
        && strcmp(closeBracket, otherBracketFunction->closeBracket) == 0;
}

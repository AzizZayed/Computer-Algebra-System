...
#ifndef LATEXIMGUITEST_METAL_TYPES_H
#define LATEXIMGUITEST_METAL_TYPES_H
...
namespace debug {
    ...
    size_t planeVertexCount = 4;
    size_t planeIndexCount = 6;
    ...
    size_t cubeIndexCount = 36;
}

#endif //LATEXIMGUITEST_METAL_TYPES_H
